...
import {LoginResponse} from "../src/interfaces/auth.interface.ts";
import {PREFIX} from "../src/helpers/API.ts";
import {Profile} from "../src/interfaces/user.interface.ts";
...
export const userSlice = createSlice({
	...
	extraReducers: (builder) => {
		...
		builder.addCase(getProfile.fulfilled, (
			state, action) => {
